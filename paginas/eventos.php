			<div class="pg-imagem-curso" style="background-image:url();">
				<div class="mascara-eventos">
					<div class="container-titulos-cursos">
							<div class="titulo-ler-noticia">EVENTOS</div>
								<div class="rota-cursos">INICIO / TODOS OS EVENTOS </div>
						</div>
				</div>
			</div>
				...
				<div class="base-foto-noticia" style="background-image:url(<?php echo $install['diretorio']; ?>admin/uplouds/<?php echo $exibe['imagem']; ?>);"></div>
					<div class="icone-vermelho-mini"></div>
						<div class="base-conteudo-noticia">
							 <a href="<?php echo $install['diretorio']; ?>evento/<?php echo $exibe['id']; ?>/<?php echo $exibe['url']; ?>"><div class="titulo-noticia"><?php echo Encurta($exibe['titulo'], 55); ?></div></a>
