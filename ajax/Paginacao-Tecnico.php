...
if(isset($id)){
	...
	$sql_total = "SELECT id FROM curso WHERE horario='tecnico' AND status='ativo'";
...
<div class="container-titulos">
		<div class="titulo"><h1>CURSOS</h1></div>
			<div class="container-titulos-ensino">
					<div class="grid-2" onClick="paginacao.iniciar('.ajax-cursos','Tecnico','1');">ENSINO MÉDIO</div>
	...
	<section class="containner">
			 <?php
                        ...
                        $sql = mysqli_query($conexao, "SELECT * FROM curso WHERE status='ativo' and horario='tecnico' ORDER BY id DESC LIMIT $inicio, $quantidade");
                            $i = 0;
