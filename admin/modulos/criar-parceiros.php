...
<?php
  ...
  $foto = $_FILES['imagem'];
        ...
        if(count($error) == 0) {
          ...
          mysqli_query($conexao, "INSERT INTO parceiro (titulo, imagem, data, link, status) VALUES ('$titulo','$nome_imagem','$data','$link','ativo')");
       ...
       echo "<script>alert('Parceiro criado!');</script>";
          mysqli_query($conexao, "INSERT INTO parceiro (titulo, data, link, status) VALUES ('$titulo','$data','$link','ativo')");
...
?>
  ...
  <div id="bx_inicio">Criar Parceiro</div>
